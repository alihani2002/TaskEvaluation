...
namespace TaskEvaluation.Core.Migrations
{
    ...
    [Migration("20240218000135_V2-FluintValidAndFolders")]
    partial class V2FluintValidAndFolders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskEvaluation.Web.Models.Assignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskEvaluation.Web.Models.Solution", b =>
                {
                    ...
                    b.HasOne("TaskEvaluation.Web.Models.Assignment", "Task")
                        .WithMany("Solutions")
